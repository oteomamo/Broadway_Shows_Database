...
<div class="container22">
    ...
    $container1Text1 = "New York, New York";
    $container1Text2 = "It is 1946, the war is over, and a resurgent New York is beginning to rebuild. As steel beams swing overhead, a collection of artists has dreams as big and diverse as the city itself. But do these singers, dancers, musicians and makers have what it takes to survive this place, let alone to succeed? If they can make it there, they can make it anywhere.";
    ?>

    
        
<div class="container11" style="display: flex; align-items: center;">
    <img src="/COP4710Project/IMGDatabase/New_York_New_York.png" alt="Example Image" style="flex: 0 0 auto; margin-right: 10px;">
    <div style="flex: 1;">
...
<div class="container12">      
    <div class="form-container">
        ...
        <form method="post" action="simpleFunction12.php">
        ...
        <?php
            if (isset($_POST['update_tickets'])) {
                ...
                $query = "UPDATE ticket_sale SET Number_of_Tickets = Number_of_Tickets - '$ticketsCount' WHERE Date = '$ticketsDate' AND Theater_ID = 712;";
...
<div class="container13" style="overflow-y: auto;">
      <?php
        ...
        if (isset($_POST['submit'])) {
            ...
            WHERE shows.Show_ID = 512 AND ticket_sale.Date BETWEEN '$startDate' AND '$endDate';";
            $result = mysqli_query($conn, $query);
