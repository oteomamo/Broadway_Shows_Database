...
<div class="container22">
    ...
    $container1Text1 = "Parade";
    $container1Text2 = "Leo and Lucille Frank are a newlywed Jewish couple struggling to make a life in the old red hills of Georgia. When Leo is accused of an unspeakable crime, it propels them into an unimaginable test of faith, humanity, justice, and devotion. Riveting and gloriously hopeful, Parade reminds us that to love, we must truly see one another.";
    ?>

    
        
<div class="container11" style="display: flex; align-items: center;">
    <img src="/COP4710Project/IMGDatabase/Parade.jpg" alt="Example Image" style="flex: 0 0 auto; margin-right: 10px;">
    <div style="flex: 1;">
...
<div class="container12">      
    <div class="form-container">
        ...
        <form method="post" action="simpleFunction7.php">
        ...
        <?php
            if (isset($_POST['update_tickets'])) {
                ...
                $query = "UPDATE ticket_sale SET Number_of_Tickets = Number_of_Tickets - '$ticketsCount' WHERE Date = '$ticketsDate' AND Theater_ID = 707;";
...
<div class="container13" style="overflow-y: auto;">
      <?php
        ...
        if (isset($_POST['submit'])) {
            ...
            WHERE shows.Show_ID = 507 AND ticket_sale.Date BETWEEN '$startDate' AND '$endDate';";
            $result = mysqli_query($conn, $query);
