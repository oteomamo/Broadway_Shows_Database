...
<div class="container22">
    ...
    $container1Text1 = "Kimberly Akimbo";
    $container1Text2 = "
...
<div class="container11" style="display: flex; align-items: center;">
    <img src="/COP4710Project/IMGDatabase/Kimberly_Akimbo.jpg" alt="Example Image" style="flex: 0 0 auto; margin-right: 10px;">
    <div style="flex: 1;">
...
<div class="container12">      
    <div class="form-container">
        ...
        <form method="post" action="simpleFunction25.php">
        ...
        <?php
            if (isset($_POST['update_tickets'])) {
                ...
                $query = "UPDATE ticket_sale SET Number_of_Tickets = Number_of_Tickets - '$ticketsCount' WHERE Date = '$ticketsDate' AND Theater_ID = 725;";
...
<div class="container13" style="overflow-y: auto;">
      <?php
        ...
        if (isset($_POST['submit'])) {
            ...
            WHERE shows.Show_ID = 525 AND ticket_sale.Date BETWEEN '$startDate' AND '$endDate';";
            $result = mysqli_query($conn, $query);
