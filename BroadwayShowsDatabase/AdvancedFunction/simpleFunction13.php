...
<div class="container22">
    ...
    $container1Text1 = "Bob Fosse's DANCIN'";
    $container1Text2 = "Fun, laughs, good times! Bob Fosse’s DANCIN’ is an all-out spectacular celebration of Fosse’s passion and those who bring it so vividly alive on stage. Utterly reimagined for the 21st century by director Wayne Cilento—who starred in the original Broadway production—this DANCIN’ brims with a level of warmth, emotion, and color rarely seen in modern interpretations of Fosse’s influential style, and features some of his most inventive and seldom performed choreography. A surefire crowd-pleaser, DANCIN' stars 22 of Broadway’s best dancers — watching them move is a thrill! This is Broadway, baby!";
    ?>

    
        
<div class="container11" style="display: flex; align-items: center;">
    <img src="/COP4710Project/IMGDatabase/Bob_Fosses_DANCIN.jpg" alt="Example Image" style="flex: 0 0 auto; margin-right: 10px;">
    <div style="flex: 1;">
...
<div class="container12">      
    <div class="form-container">
        ...
        <form method="post" action="simpleFunction13.php">
        ...
        <?php
            if (isset($_POST['update_tickets'])) {
                ...
                $query = "UPDATE ticket_sale SET Number_of_Tickets = Number_of_Tickets - '$ticketsCount' WHERE Date = '$ticketsDate' AND Theater_ID = 713;";
...
<div class="container13" style="overflow-y: auto;">
      <?php
        ...
        if (isset($_POST['submit'])) {
            ...
            WHERE shows.Show_ID = 513 AND ticket_sale.Date BETWEEN '$startDate' AND '$endDate';";
            $result = mysqli_query($conn, $query);
