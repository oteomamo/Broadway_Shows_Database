...
<div class="container22">
    ...
    $container1Text1 = "Harry Potter and the Cursed Child";
    $container1Text2 = "Adventure runs in the family. When Harry Potter’s head-strong son Albus befriends the son of his fiercest rival, Draco Malfoy, it sparks an unbelievable new journey for them all—with the power to change the past and future forever. Prepare for a mind-blowing race through time, spectacular spells, and an epic battle, all brought to life with the most astonishing theatrical magic ever seen on stage. You’ll be wondering ‘how’d they do that?’ for days to come";
    ?>

    
        
<div class="container11" style="display: flex; align-items: center;">
    <img src="/COP4710Project/IMGDatabase/Harry_Potter_And_The_Cursed_Child.jpg" alt="Example Image" style="flex: 0 0 auto; margin-right: 10px;">
    <div style="flex: 1;">
...
<div class="container12">      
    <div class="form-container">
        ...
        <form method="post" action="simpleFunction6.php">
        ...
        <?php
            if (isset($_POST['update_tickets'])) {
                ...
                $query = "UPDATE ticket_sale SET Number_of_Tickets = Number_of_Tickets - '$ticketsCount' WHERE Date = '$ticketsDate' AND Theater_ID = 706;";
...
<div class="container13" style="overflow-y: auto;">
      <?php
        ...
        if (isset($_POST['submit'])) {
            ...
            WHERE shows.Show_ID = 506 AND ticket_sale.Date BETWEEN '$startDate' AND '$endDate';";
            $result = mysqli_query($conn, $query);
